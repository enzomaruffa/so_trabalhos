...
void suspend_disk_task() {

}

void suspend_disk_request_task() {
    
}

void wake_up_disk_request_task(task_t* task) {
...
void ppos_init () 
{
    ...
    disk_task = malloc(sizeof(task_t));
    task_create(disk_task, disk_mgr_body, NULL);
